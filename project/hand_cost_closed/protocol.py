...
class ClosedHandCostProtocol(Protocol):
    tiles_unique = 34
    ...
    input_size = 1 + tiles_unique * 6 + max_dora_on_the_table + winds_input_size
    output_size = 9
    ...
    def parse_new_data(self, raw_data):
        for index, row in raw_data:
            ...
            input_data = list(itertools.chain(
                [row['tenpai_player_in_riichi'] and 1 or 0],
                winds_input,
            ...
            for x in waiting_temp:
                ...
                key = ClosedHandCostProtocol.create_hand_cost_key(han, fu)
